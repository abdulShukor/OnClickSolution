...
namespace OnClickSolution.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            var products = _db.Products.Include(m => m.Categories);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ProductsVM.Products = await _db.Products.Include(m => m.SpecialTags).Include(m => m.Categories).SingleOrDefaultAsync(m => m.Id == id);
        ...
        public async Task<IActionResult> Edit(int id)
        {
            if (ModelState.IsValid)
            {
                ...
                productFromDb.OriginalPrice = ProductsVM.Products.OriginalPrice;
                productFromDb.PromotionalPrice = ProductsVM.Products.PromotionalPrice;
